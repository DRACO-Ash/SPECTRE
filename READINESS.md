...
Archetype: server (container) · Template: **python** · Version **0.5.3**
...
| Version stamp and audit row, generic client errors | medium | **PASS** | Single-sourced 0.5.3; boot logs its storage verdict |
...
| | |
|---|---|
| Artefact | `dist/spectre-0.5.3-appstore.zip` |
...
| Version | 0.5.3, matching the artifact stamp and the app's own version field |
