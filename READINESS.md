...
Archetype: server (container) · Template: **python** · Version **0.4.1**
...
| Version stamp and audit row, generic client errors | medium | **PASS** | Single-sourced 0.4.1; boot logs its storage verdict |
...
| | |
|---|---|
| Artefact | `dist/spectre-0.4.1-appstore.zip` |
...
| Version | 0.4.1, matching the artifact stamp and the app's own version field |
