...
Archetype: server (container) · Template: **python** · Version **0.5.8**
...
| Version stamp and audit row, generic client errors | medium | **PASS** | Single-sourced 0.5.8; boot logs its storage verdict |
...
| | |
|---|---|
| Artefact | `dist/spectre-0.5.8-appstore.zip` |
...
| Version | 0.5.8, matching the artifact stamp and the app's own version field |
