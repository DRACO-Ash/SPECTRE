...
package and the SIPC threat-sweep pipeline.  It is intentionally thin — all
...
:func:`sipc.web.routes.udl.fetch_tle_history_for_satno`.  The function
...
def cluster_and_reduce_tle_cache(
    ...
    * All noise (very rare): the pre-existing cached TLE is retained unchanged
    ...
    tle_multiset:
        ...
        Populated by :func:`sipc.web.routes.udl.fetch_tle_history_for_satno`.
    existing_cache:
    ...
    config_dict:
        ``sipc.config.constants.TLE_CLUSTERING`` dict.
